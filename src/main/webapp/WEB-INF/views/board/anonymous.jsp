                    ...
                    <div class="card">
                        <div class="card-body">
                                        ...
                                        <table class="table">
                                            ...
                                            <c:forEach items="${todayBestPosts}" var="list">
                                                <tr>
                                                    ...
                                                    <td><a href="/board/read/an?board_seq=${list.board_seq}">${list.title}</a></td>
                            ...
                            <div class="pagination-container">
                                ...
                                <button type="button" class="btn btn-outline-info btn-fw" id="write">
                                    <div class="mdi mdi-border-color">글쓰기</div>
                                </button>
                            </div>
