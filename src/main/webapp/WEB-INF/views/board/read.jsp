...
<%@ taglib prefix="white-space" uri="http://java.sun.com/jsp/jstl/core" %>
<!-- Required meta tags -->
<meta charset="utf-8">
...
<style>
    ...
    .text {
        ...
        padding: 0; /* 패딩 제거 */
        margin: 0; /* 마진 제거 */
        color: #e4eaec; /* 글자 색상 설정 */
        white-space: pre-wrap; /* 줄 바꿈 유지 */
        font-family: '맑은고딕', sans-serif; /* 폰트 설정 */
    }

    .best-comment {
        border: 1px solid #0090e7; /* 테두리 색상과 스타일 설정 */
        padding: 10px; /* 내부 여백 */
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-center">
                                ...
                                <c:if test="${sessionScope.loginMember.user_seq == memberdto.user_seq}">
                                    ...
                                    <button type="button" class="btn btn-outline-secondary btn-icon-text" onclick="confirmDelete()">
                                        삭제
                                    </button>
                                        <input type="hidden" name="board_seq" value="${seq}">
                                    </form>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="card-body">
                                ...
                                <c:forEach var="comment" items="${bestCommentList}">
                                    <div class="best-comment">
                                        <p style="color:#e4eaec;"><strong>${comment.name}</strong> (${comment.likes} 추천)</p>
                                        <p>${comment.content}</p>
                                    </div>
                                </c:forEach>
                                            ...
                                            <div class="preview-item-content d-flex flex-grow">
                                                <div class="flex-grow">
                                                    <div class="d-flex d-md-block d-xl-flex justify-content-between">
                                                        <h6 class="preview-subject">${list.name}
                                                    ...
                                                    <div class="text-body">
                                                    <pre class="text" >${list.content}</pre>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
<%--                                    <input type="text" class="form-control todo-list-input" placeholder="글쓰기.." name="content">--%>
                                    <textarea class="form-control todo-list-input" style="color: #e4eaec" placeholder="글쓰기.." name="content" rows="4"></textarea>
